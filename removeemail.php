...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
 ...
 <a href="http://amagsino.web540.net/final/sendemail.html" class="w3-bar-item w3-button w3-padding">About Us</a> 
...
<?php
  ...
  $query = "DELETE FROM final_email WHERE email = '$email'";
	mysqli_query($dbc, $query)
    or die('Error querying database.');
  echo 'Your email: ' . $email, ' has been removed. You will no longer be contacted.';
